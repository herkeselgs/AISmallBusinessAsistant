...
const METRICS: Metric[] = [
  ...
  { key: "demos", label: "Demos given", target: 25 },
...
type State = { values: Record<string, number>; testimonials: string; quotes: string };
const INITIAL: State = {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <TextCard
          ...
          placeholder={"“Folvra booked me a $6k job while I was on a roof.” — Mike, Summit Remodeling"}
        />
        <TextCard
      ...
      <p className="text-xs text-ink-faint">
        Saved in this browser (localStorage). These are the numbers a YC partner asks for — update
        them daily.
      </p>
    </div>
  );
