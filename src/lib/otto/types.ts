...
/** Where a lead came in from (derived from the notifying email). */
...
/** A lead's lifecycle in the inbox. */
export type LeadStatus = "new" | "drafted" | "sent" | "booked" | "won";

/**
 * A lead as it appears in the product's inbox/dashboard. In production this is a
 * row in Postgres; in the demo workspace it's generated by the engine.
 */
